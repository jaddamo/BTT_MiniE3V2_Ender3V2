...
#define STRING_CONFIG_H_AUTHOR "(Parallel-40 NYC , 2.0.9.2-3)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Parallel 40 Corp. ID:E3001-A"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "E3001-A"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    // Ender 3 v2 DUAL Z spec
    #define DEFAULT_Kp  29.92
    #define DEFAULT_Ki   3.49
    #define DEFAULT_Kd  64.18
  #endif
#endif // PIDTEMP
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -43, -9, -1 }
...
#define PREHEAT_2_LABEL       "Polypropylene PP"
